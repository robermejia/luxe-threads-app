...
public class DataInitializer {
        ...
        public CommandLineRunner initData(ProductFirestoreService firestoreService, UserFirestoreService userService) {
                return args -> {
                        // Initialize Products only if database is empty
                        try {
                                if (firestoreService.countProducts() == 0) {
                                        System.out.println("Iniciando sincronización de catálogo inicial...");
                                        Product[] initialProducts = {
                                                        ...
                                                        new Product(null, "Blazer Slim Fit Gris", 150.0, 180.0,
                                                                        ...
                                                                        "Blazer elegante para ocasiones especiales.",
                                                                        8),
                                                        ...
                                                        new Product(null, "Camiseta Algodón Pima", 35.0, null,
                                                                        ...
                                                                        "Camiseta de algodón premium de tacto suave.",
                                                                        100),
                                                        ...
                                                        new Product(null, "Camisa Lino Blanca", 55.0, null,
                                                                        ...
                                                                        "Camisa 100% lino perfecta para el verano.",
                                                                        45),
                                        ...
                                        System.out.println(
                                                        "Catálogo sincronizado correctamente con 15 productos iniciales.");
                                } else {
                                        System.out.println("Catálogo ya existente. Omitiendo sincronización inicial.");
                                }
                        } catch (Exception e) {
